      ...
      <?php foreach ($order_data['order_item'] as $key => $val): ?>
       ...
       <tr id="row_<?php echo $x; ?>">
        ...
        <?php endif ?>
          ...
          <td>
          <input type="hidden" name="cgst[]" id="cgst_<?php echo $x; ?>" class="form-control" value="<?php echo $val['cgst_tax'] ?>">
                    <input type="hidden" name="sgst[]" id="sgst_<?php echo $x; ?>" class="form-control" value="<?php echo $val['sgst_tax'] ?>">
...
<!-- /.box-body -->
              ...
              <div class="box-footer" style="padding: 0 0 20px 17px;">
                ...
                <a href="<?php echo base_url('Controller_InPurchase/create') ?>" class="btn btn-primary"><?php echo lang('new_inpurchase'); ?></a>
              </div>
            </form>
                                    </div>
                                </div>
