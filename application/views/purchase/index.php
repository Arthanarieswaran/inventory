        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">
                     <?php echo lang('manage_purchases'); ?>
                    <?php if(in_array('createPurchase', $user_permission)): ?>
                      <a href="<?php echo base_url('Controller_Purchase/create') ?>"  style="padding:0 5px !important;" class="btn btn-primary">Add Purchase</a>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal" data-backdrop="static">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Controller_Purchase/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    dom: 'Bfrtip',
    'ajax': base_url + 'Controller_Purchase/fetchPurchasesData',
    'order': []
  });
