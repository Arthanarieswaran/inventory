    ...
    <div class="container-fluid">
      ...
      <div class="form-group col-md-3">
        ...
        <div class="col-12">
                                ...
                                <div class="card">
                                <button class="btn btn-sm btn-success" style="width: 6%;" onclick="ExportToExcel('Purchase','xlsx')">Excel</button>
                                    <div class="card-body" id="Purchase">
                                        <table class="table table-responsive">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th colspan="16" style="text-align: center;"> Purchase Details</th>
                                                </tr>
                                            <tr>
                                                <th>SNO</th>
                                                <th>Date</th>
                ...
                success:function(response) {
                    ...
                    if(response.length > 0){
                        ...
                        $.each(response,function(key,value){
                            var tgst = parseFloat(value.cgst) + parseFloat(value.sgst);
                            var tprice = parseFloat(value.amount) * (parseFloat(tgst)/100);
                            var gstRate  = parseFloat(tprice/2);
                            var qty = value.qty;
                            var gtotal = parseFloat(value.amount)+parseFloat(gstRate);
                            var qtyName = 'Piece';
                            ...
                            $('#patchData').append('<tr>'+
                        '<td>'+(key+1)+'</td>'+
                        '<td>'+moment(value.dt).format("DD-MM-YYYY")+'</td>'+
